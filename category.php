...
<div class="main">
    ...
    <div class="headline">
        ...
        <?php else : ?>
            <h2>Latest <?php echo esc_html(single_cat_title('', false)); ?> Videos</h2>
        <?php endif; ?>
        
        <div class="sorting">
            <a class="btn sub<?php echo ($v_sortby == "views") ? ' active' : ''; ?>" href="?v_sortby=views&amp;v_orderby=desc">Most Viewed</a>
            <a class="btn sub<?php echo ($v_sortby != "views") ? ' active' : ''; ?>" href="<?php echo esc_url(get_category_link(get_queried_object_id())); ?>">Date</a>
        </div>
    </div>
